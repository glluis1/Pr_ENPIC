...
datos_dhanp <- datos %>%
  ...
  mutate(
    ...
    Colestasis_d1 = case_when(
      ...
      (FALCALI1 > 280 | GAMGT1 > 50 | FILIRUB1 > 1.2) %in% TRUE ~ TRUE,
      TRUE ~ FALSE
    ),
    ...
    Necrosis_d1 = case_when(
      ...
      ((GOT1 > 40 | GPT1 > 42) & (FILIRUB1 > 1.2 | INR1 > 1.4)) %in% TRUE ~ TRUE,
      TRUE ~ FALSE
    ),
    ...
    DHANP_d1 = if_else(Colestasis_d1 | Necrosis_d1, 1, 0)
  )
