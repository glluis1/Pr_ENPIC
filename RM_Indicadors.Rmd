...
# Función para instalar paquetes de una lista
...
caracterizacion_muestra <- function(datos, comparar = NULL, excluir = NULL) {
  ...
  variables <- c(
    ...
    "NUTRIC_Score", "NUTRISCOR2", "HORASIN", "TIPO_SN_Grupo", "SN_Menos48h", 
    "TOTAL_DIAS_SN", "Kcal_14d", "gPROT_14d", "PCOMPLIG", "PVRGM100", "PDANE", 
    "PCLOSTDIF", "PVOMITO", "PBRONCOAS", "PISQUINT", "VM", "DIASVM", "NEC_NA", 
    "TRR", "INFRESP", "INFVIA", "DIAS_UCI", "DIAS_HOSP", "MUERTO28"
  )
  ...
  bloques <- list(
    ...
    `Terapia nutricional` = c(
      "HORASIN", "TIPO_SN_Grupo", "SN_Menos48h", "TOTAL_DIAS_SN", "Kcal_14d", 
      "gPROT_14d", "PCOMPLIG", "PVRGM100", "PDANE", "PCLOSTDIF", "PVOMITO", 
      "PBRONCOAS", "PISQUINT"
    ),
    Resultados = c(
      "VM", "DIASVM", "NEC_NA", "TRR", "INFRESP", "INFVIA", "DIAS_UCI",
      "DIAS_HOSP", "MUERTO28"
    )
  )
  ...
  for (nombre_bloque in names(bloques)) {
    ...
    etiquetas <- lista_etiquetas[names(lista_etiquetas) %in% vars_bloque]
  ...
  if (!is.null(by_argument)) {
    tabla <- tabla %>%
      modify_header(label = "**Variable**", p.value = "**Valor p**") %>%
      modify_footnote(
        all_stat_cols() ~ 
...
caracterizacion_muestra(datos, comparar = TIPO_SN_Grupo)
caracterizacion_muestra(datos, comparar = NUTRISCOR2, excluir = "NUTRIC_Score")
...
vars_cox <- c(
  "EDAD", "ALCOHOL", "AHTA", "AEPOC", "AIRC", "AINMUNO", "ANEOPLAS", 
  "STATUS3", "APACHEII", "SOFA1", "NUTRIC_Score", "TIPO_SN_Grupo", 
  "gPROT_14d", "VM", "NEC_NA", "TRR", "INFVIA"
)
